          ...
          <form onSubmit={ sendEmail }>
            <div className="md:flex items-center mt-12">
              <div className="w-full flex flex-col">
                  ...
                  <input type="text" className="leading-none text-gray-900 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200" name="name" />
              </div>
            ...
            <div>
              <div className="w-full flex flex-col mt-8">
                  ...
                  <textarea type="text" className="h-40 text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200" name="message"></textarea>
              </div>
            </div>
